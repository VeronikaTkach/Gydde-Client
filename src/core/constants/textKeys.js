...
export const TEXT_KEYS = {
  ...
  PROFILE: [
    `${PageName.Profile}_Guides.btnText`,
    `${PageName.Profile}_Guides.rewardsTitle`,
    `${PageName.Profile}_Guides.rewardsTotal`,
    `${PageName.Profile}_Guides.referalTitle`,
    `${PageName.Profile}_Guides.referalTotal`,
    `${PageName.Profile}_Guides.earningsTitle`,
    `${PageName.Profile}_Guides.earningsTotal`,
    `${PageName.Profile}_Referals.btnText`,
    `${PageName.Profile}_Referals.rewardsTitle`,
    `${PageName.Profile}_Referals.rewardsTotal`,
    `${PageName.Profile}_Referals.referalTitle`,
    `${PageName.Profile}_Referals.referalTotal`,
    `${PageName.Profile}_Referals.earningsTitle`,
    `${PageName.Profile}_Referals.earningsTotal`,
  ],
};
